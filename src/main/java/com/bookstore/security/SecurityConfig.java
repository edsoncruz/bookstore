    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests((requests) -> requests
                    ...
                    .requestMatchers(HttpMethod.PUT, "/books","/bookTypes","/customer","/loyalties","/users").hasRole(Role.ADMIN.name())
                    .requestMatchers(HttpMethod.DELETE, "/books","/bookTypes","/customer","/loyalties","/users").hasRole(Role.ADMIN.name())
